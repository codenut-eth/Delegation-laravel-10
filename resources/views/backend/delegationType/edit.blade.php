...
@section('title','DELE || Type Edit')
@section('main-content')

<div class="card">
    <h5 class="card-header">Edit Delegation Type</h5>
    <div class="card-body">
      <form method="post" action="{{route('type.update',$type->id)}}">
        ...
        <input id="inputName" type="text" name="name" placeholder="Enter name"  value="{{$type->name}}" class="form-control">
        @error('name')
